...
public class hello {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter Your Lnameess :");
        ...
        person.details(Fname, Lname , city);
...
class PersonInfo {
    ...
    public void details(String Fname , String Lname , String city) {
        System.out.println("Hello " + Fname + " are you living in " + Lname +" is it near to " + city);
    }
}
